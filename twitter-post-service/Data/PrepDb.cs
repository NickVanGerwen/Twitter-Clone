        ...
        public static void SeedData(AppDbContext context)
        {
            if (!context.Posts.Any())
            {
                ...
                List<Post> Posts = new List<Post>()
                {
                    ...
                    new Post() {Id =1 , Message = "in feugiat urna hendrerit. Nam cursus risus id sem aliquam, vel commodo purus euismod. Quisque consectetur nec neque id sagittis. Nam at bibendum arcu. Nam rutrum vulputate nibh eget auctor. Vestibulum maximus blandit lectus, a tristique sem venenatis in. Fusce placerat leo sed maximus consequat.\r\n\r\n", Author = "John Doe", Date = DateTime.Now, Likes =11},
                    new Post() {Id =1 , Message = "Ut iaculis tincidunt fermentum. Pellentesque rhoncus quam in mi venenatis interdum. Sed vestibulum suscipit diam ut molestie. In hac habitasse platea dictumst. ", Author = "John Doe", Date = DateTime.Now, Likes =223},
                    new Post() {Id =1 , Message = "ac egestas ligula. Quisque eget iaculis justo, in congue turpis. Nam scelerisque viverra lectus non lobortis. Suspendisse dapibus tellus at egestas egestas. Integer at mauris non sapien molestie pulvinar. Aenean dictum pharetra leo vitae feugiat. Proin non pulvinar sapien.", Author = "John Doe", Date = DateTime.Now, Likes =223},
                    new Post() {Id =1 , Message = "Praesent eget nisi sed velit ullamcorper cursus. Praesent eu nunc in lorem bibendum finibus sit amet in orci. Nullam in consequat odio, elementum laoreet ex. ", Author = "Jane Doe", Date = DateTime.Now, Likes =432 },
                    new Post() {Id =1 , Message = "Etiam ac odio sed ipsum congue suscipit a non turpis. Maecenas dictum in tellus ut rhoncus. Maecenas et nibh ut lectus rutrum commodo consectetur sollicitudin nisi. ", Author = "Jane Doe", Date = DateTime.Now, Likes =312}
                };
